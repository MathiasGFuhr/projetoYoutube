...
const fragmentShaderSource = `
  ...
  const vec4 lineColor = vec4(1.0, 0.06, 0.06, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.02, 0.005, 0.005, 1.0);
    vec4 bgColor2 = vec4(0.16, 0.015, 0.015, 1.0);
    ...
    fragColor.a = 1.0;
    fragColor += vec4(drawGrid(space) * gridColor.rgb * 0.08, 1.0);
